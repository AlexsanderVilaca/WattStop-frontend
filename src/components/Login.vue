                            ...
                            <v-row>
                                <v-col cols="12" sm="6">
                                    <v-card-text class="mt-12">
                                        <h4 class="text-center">Faça login poga</h4>
                                        <h6 class="text-center grey--text">Faça o login na sua conta </h6>
                                        <v-row align="center" justify="center">
                                            <v-col cols="12" sm="8">
...
export default {
    ...
    methods: {
        jurema: () => {
            const resp = login({usuario: usuario.value, password: password.value})
